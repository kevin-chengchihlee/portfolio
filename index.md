...
C|SIMULINK|STM32|CANBUS|dSPACE|Real-Time System|Automotive<br>
...
- **LightSwarm Network:**  
C|Python|ESP32|RaspberryPi|UDP|FreeRTOS|Real-Time System<br>
...
C|Python|Infineon Aurix|dSPACE|ASPICE|HiL|Jenkins|VectorCAST|MISRA C<br>
